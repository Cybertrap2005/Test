...
app.listen(PORT, (success) => {
    ...
    const teams = new Game_1.default("teams", "2 Teams");
    const fourteams = new Game_1.default("4teams", "4 Teams");
    const maze = new Game_1.default("maze", "Maze");
    const mot = new Game_1.default("mot", "Mothership");
    const sbx = new Game_1.default("sandbox", "Sandbox");
    games.push(ffa, teams, fourteams, maze, mot, sbx);
