...
const CUSTOM_ADDONS = {
    ...
    "megasmasher": entity => {
        ...
        const hexagon = rotator.createChild(true);
        hexagon.defaults();
        hexagon.physicsData.size = 45.2; // Size of the hexagon
        hexagon.physicsData.sides = 6; // Number of sides for the hexagon
        hexagon.styleData.color = 0; // Color of the hexagon
        hexagon.positionData.angle = 0;
        hexagon.positionData.x = 0;
        hexagon.positionData.y = 0;
    },
    "testpronounced": entity => {
    if (!(entity instanceof $Entity)) return;
        ...
        rect1.physicsData.size = sizeRatio * size;
        rect1.physicsData.width = widthRatio * size;
        rect1.positionData.x = offsetRatio * size;
